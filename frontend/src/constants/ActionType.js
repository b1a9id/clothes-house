...
const GET_GENRES_PREFIX = "GENRES";
export const START_GET_GENRES = GET_GENRES_PREFIX + START_REQUEST;
export const GET_GENRES_RESPONSE = GET_GENRES_PREFIX + RECEIVE_DATA;
export const FINISH_GET_GENRES = GET_GENRES_PREFIX + FINISH_REQUEST;
